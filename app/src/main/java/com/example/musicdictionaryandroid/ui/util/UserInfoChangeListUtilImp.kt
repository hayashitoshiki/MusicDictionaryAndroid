 ...
 * 各数値項目の変換
 */
object UserInfoChangeListUtilImp : UserInfoChangeListUtil {
    ...
    override fun changeGender(code: Int): String {

        return genderList[code]
    }

    override fun changeArea(code: Int): String {
    ...
    override fun changeGenre1(index: Int): String {

        return mainGenreList[index]
    }

    override fun changeGenre2(genre1Index: Int, genre2Index: Int): String {
    ...
    override fun changeVoice(index: Int): String {
        return when (index) {
            1 -> "声が低い"
            2 -> "やや声が低い"
            3 -> "中間の声"
    ...
    override fun changeLength(index: Int): String {
        return when (index) {
            1 -> "曲が短い"
            2 -> "曲がやや短め"
            3 -> "中間"
    ...
    override fun changeLyrics(index: Int): String {
        return when (index) {
            1 -> "外国語が多い"
            2 -> "外国語がやや多い"
            3 -> "外国語と日本語が半々"
