...
class FabTransform : Transition {
    ...
    constructor(@ColorInt fabColor: Int, @DrawableRes fabIconResId: Int, mode: Int) {
        color = fabColor
        icon = fabIconResId
    ...
    override fun createAnimator(
        ...
        if (!fromFab) {
            elevation =
                ObjectAnimator.ofFloat(view, View.TRANSLATION_Z, -view.elevation)
    ...
    companion object {
       ...
       // 矩形時間 Defaoult 240L
        ...
        fun setup(activity: Activity, @Nullable target: View?): Boolean {
            ...
            if (!intent.hasExtra(EXTRA_FAB_COLOR) || !intent.hasExtra(
            ...
            val color =
                intent.getIntExtra(EXTRA_FAB_COLOR, Color.TRANSPARENT)
